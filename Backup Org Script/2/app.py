...
def main():
    ...
    # Trend Movement Analysis expander (uses historical data but respects Branch/Officer selections)
    ...
    # --- Daily Arrears Movement (uses full history, respects branch/officer/product selections) ---
