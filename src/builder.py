...
def build_weekly_recovery_report(
    ...
    Functional entry point for the recovery engine.
    Handles instantiation and execution of the reporting pipeline.
    """
    builder = RecoveryEngineBuilder()
    return builder.build_weekly_recovery_report(branch_name, df_branch, full_df)